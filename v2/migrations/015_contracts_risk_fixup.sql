...
INSERT INTO permissions (id, module, action, description) VALUES
  ('contract.view', 'contracts', 'view', 'View physical contracts'),
  ('contract.create', 'contracts', 'create', 'Create physical contracts'),
  ('contract.update', 'contracts', 'update', 'Update physical contracts'),
  ('contract.delete', 'contracts', 'delete', 'Delete/cancel physical contracts'),
  ('counterparty.view', 'contracts', 'view', 'View counterparties'),
  ('counterparty.create', 'contracts', 'create', 'Create counterparties'),
  ('counterparty.update', 'contracts', 'update', 'Update counterparties'),
  ('counterparty.delete', 'contracts', 'delete', 'Delete counterparties'),
  ('risk.view', 'risk', 'view', 'View risk data'),
  ('risk.mtm', 'risk', 'create', 'Run mark-to-market'),
  ('risk.limits', 'risk', 'update', 'Manage position limits'),
  ('risk.limit_check', 'risk', 'create', 'Run limit checks')
