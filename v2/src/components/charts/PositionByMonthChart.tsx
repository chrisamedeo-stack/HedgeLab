...
export function PositionByMonthChart({ data, height = 320 }: PositionByMonthChartProps) {
  if (data.length === 0) {
    return (
      <div className="bg-surface border border-b-default rounded-lg p-5">
        <h2 className="text-xs font-semibold uppercase tracking-wider text-muted mb-4">Positions by Month</h2>
