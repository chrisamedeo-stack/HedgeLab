...
import { fmtPerBu, fmtPnl, pnlColor } from "@/lib/corn-format";
          ...
          <Fragment key={g.futuresMonth}>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-secondary tabular-nums">{fmtVol(g.totalBu - g.unallocBu, config.bushelsPerMt)}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] uppercase text-ph leading-tight">Unalloc Bu</span>
                <span className="text-sm text-profit tabular-nums font-semibold">{fmtVol(g.unallocBu, config.bushelsPerMt)}</span>
              </div>
              <div className="flex flex-col">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                      ...
                      return (
                        <Fragment key={h.hedgeTradeId}>
                          <tr className="border-t border-b-default hover:bg-row-hover transition-colors">
                            ...
                            <td className="px-4 py-2 font-semibold text-profit tabular-nums">{fmtVol(h.unallocatedBushels, config.bushelsPerMt)}</td>
                    ...
                    <tr className="border-t border-b-default bg-tbl-header font-semibold text-xs">
                      ...
                      <td className="px-4 py-1.5 text-secondary tabular-nums">{fmtVol(g.unallocBu, config.bushelsPerMt)}</td>
