        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="bg-slate-800/40">
              ...
              <th className="px-3 py-1.5 text-right text-slate-500 font-medium">Forecast Bu</th>
          ...
          <tbody className="divide-y divide-slate-800/50">
            {visible.map((h) => (
              <tr key={h.id}>
                ...
                <td className="px-3 py-1.5 text-right tabular-nums text-slate-300">{fmtVol(h.forecastBu)}</td>
